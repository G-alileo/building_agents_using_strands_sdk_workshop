...
def find_character_by_name(name: str) -> str:
    ...
    return json.dumps(character)  # Fixed: return json string instead of dict
...
def list_all_characters() -> str:
    ...
    return json.dumps(all_chars)  # Fixed: return json string instead of list
...
def create_character(
    ...
    print("Inserted")
    return json.dumps(asdict(character))  # Fixed: return json string instead of dataclass object
